   ...
   public partial class FullBoletoLayout : UserControl {
      ...
      public FullBoletoLayout(Cedente cedente, Medicao medicao) {
         ...
         if (contaSelecionada == null) {
            ...
            boletoForm1.MakeBoleto(Cedente.makeCedenteInfo(cedente, contaSelecionada, medicao.carteiraSelecionada, ""), Sacado.makeSacadoInfo(medicao.sacado, medicao.casa), modelos.Boleto.makeBoleto(cedente, medicao));
         }
      }
