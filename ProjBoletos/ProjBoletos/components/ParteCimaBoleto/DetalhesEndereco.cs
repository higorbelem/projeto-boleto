...
namespace ProjBoletos.components.ParteCimaBoleto {
   public partial class DetalhesEndereco : UserControl {
      ...
      public DetalhesEndereco(int radius, float lineWidth, Medicao medicao) {
         InitializeComponent();

         this.radius = radius;
         this.lineWidth = lineWidth;

         valor1 = medicao.sacado.nome;
         valor2 = medicao.casa.rua + ", " + medicao.casa.numero;
         valor3_1 = medicao.casa.bairro;
         valor3_2 = medicao.casa.cidade + "/" + medicao.casa.uf;
         valor4 = medicao.casa.cep;
         valor5 = medicao.casa.referencia;
