...
namespace ProjBoletos.components {
    public partial class MainCard : UserControl {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            e.Graphics.FillRectangle(new SolidBrush(atualColor),new Rectangle(0,0,Width,Height));
            ...
            Rectangle imgRect = new Rectangle((Width / 2) - (icon.Width / 2), (Height / 2) - (icon.Height / 2) + 20, 150, 150);
            ...
            e.Graphics.DrawString("10", new Font("Ebrima", 10, FontStyle.Bold), new SolidBrush(Color.White), notifRect, sfNotif);
            ...
            e.Graphics.DrawString("25", new Font("Ebrima", 40, FontStyle.Bold), new SolidBrush(ColorTranslator.FromHtml("#3289d8")), imgRect, sfImgNumber);


            Rectangle tituloRect = new Rectangle(0,notifRect.Y,Width-notifRect.Width-notifPadding,notifRect.Height);
            StringFormat sf = new StringFormat();
            sf.LineAlignment = StringAlignment.Center;
            sf.Alignment = StringAlignment.Center;
            e.Graphics.DrawString("Você tem boletos para imprimir", new Font("Ebrima", 13, FontStyle.Bold), new SolidBrush(Color.White), tituloRect, sf);

            e.Graphics.FillRectangle(new SolidBrush(ColorTranslator.FromHtml("#3289d8")), new Rectangle(0,Height-10,Width,10));
        }
    }
}
